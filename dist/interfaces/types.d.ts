...
import { AmenityID } from "../components/map-box/MapBox";
import { MapDeviceType, MapRole, MapStyleType } from "src/constants/globals";
...
export interface IConfig {
    ...
    ZOOM_STEP?: string;
    SELECTED_ZOOM_LIMIT?: string;
    SELECTED_ZOOM_LIMIT_DISTANCE: number;
}
