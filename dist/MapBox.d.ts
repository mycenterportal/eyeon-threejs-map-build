...
declare function MapBox({ mapitData, config, onSettingsLoading, webApiURI, mediaStorageURI, onSubmit, refObj, onResetData }: IAppProps): import("react/jsx-runtime").JSX.Element | null;
