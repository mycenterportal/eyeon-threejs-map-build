...
declare const useRouteHelper: () => {
    ...
    create_route: (allNodesFloor: Record<string, number>, from_mesh_object_id: string, to_mesh_object_id: string, scene: Scene, floors: AppFloor[], escalator_nodes: string[], pathFinderGraph: Graph, style: string) => Mesh[];
    ...
    make_amenity_route: (kiosk_obj_name: string, amenity_type: string, scene: Scene, escalator_nodes: string[], style: string) => Mesh[];
